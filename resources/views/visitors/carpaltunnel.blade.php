@extends('visitors.layouts.visitorsApp',['title' => 'Carpal Tunnel '])
@section('content')
        ...
        <div class="auto-container mt-5 mb-5">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12 pr-lg-8 pr-md-8 pr-sm-0 pr-0 mb-lg-0 mb-md-0 mb-sm-5 mb-5 about-us-into">
					...
					<h3>Treat <Span> Carpal Tunnel </Span>Syndrome with the most effective surgery
					</h3>
					<p>Treat painful symptoms of Carpal Tunnel Syndrome with the most effective and safest surgical treatment at Prabha Hospital.</p>
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-12 pr-lg-8 pr-md-8 pr-sm-0 pr-0 mb-lg-0 mb-md-0 mb-sm-5 mb-5">
					<img src="https://prabha-hospital.com/assets/img/diseases/Carpal-tunnel-syndrome-identification-and-management.webp"
