@extends('visitors.layouts.visitorsApp',['title' => 'IVF treatment'])
@section('content')
        ...
        <div class="auto-container mt-5 mb-5">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12 pr-lg-8 pr-md-8 pr-sm-0 pr-0 mb-lg-0 mb-md-0 mb-sm-5 mb-5 about-us-into">
					...
					<h3>Step into parenthood with the best <span> IVF treatment</span>
					</h3>
					<p>Live the joys of parenthood and embark on a beautiful journey of life with the best IVF fertility treatment
					</p>
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-12 pr-lg-8 pr-md-8 pr-sm-0 pr-0 mb-lg-0 mb-md-0 mb-sm-5 mb-5">
					<img src="https://prabha-hospital.com/assets/img/diseases/fertilsa.jpg"
