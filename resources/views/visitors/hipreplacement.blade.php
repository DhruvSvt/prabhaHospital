@extends('visitors.layouts.visitorsApp',['title' => 'Hip Replacement Surgery'])
@section('content')
        ...
        <div class="auto-container mt-5 mb-5">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 col-12 pr-lg-8 pr-md-8 pr-sm-0 pr-0 mb-lg-0 mb-md-0 mb-sm-5 mb-5 about-us-into">
					...
					<h3>Most Advanced Minimally Invasive <span> Hip Replacement Surgery </span>
					</h3>
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-12 pr-lg-8 pr-md-8 pr-sm-0 pr-0 mb-lg-0 mb-md-0 mb-sm-5 mb-5">
					<img src="https://prabha-hospital.com/assets/img/diseases/Hip Replacement.jpg"
			...
			<div class="row">
			 <!--   <div class="col-lg-6 col-md-6 col-sm-12 col-12 pr-lg-8 pr-md-8 pr-sm-0 pr-0 mb-lg-0 mb-md-0 mb-sm-5 mb-5">-->
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-12 pr-lg-8 pr-md-8 pr-sm-0 pr-0 mb-lg-0 mb-md-0 mb-sm-5 mb-5 about-us-into">
					<!--<h6>Since 1990 - 2020, Battery Park, New York</h6>-->
					<h3>What is <span> hip replacement?</span>
					</h3>
					<p>Hip replacement is the surgical procedure of replacing a hip joint with a prosthetic implant. There are two types of hip replacement - Hemi Replacement or Total Replacement. As the name suggests, in a hemi replacement, the surgeon replaces half of the hip joint. But, in a total hip replacement, the surgeon replaces the entire hip joint. Hip replacement is also known as hip arthroplasty and can be considered as a treatment option for your hip pain.</P>
					<!--<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. </p>-->
				</div>
			</div>
        </div>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
						<div id="tabsJustifiedContent" class="tab-content">
							<div id="one" class="tab-pane animated fadeInRight active show">
									<ul>
									    <li><h6><i class="icofont icofont-long-arrow-right mr-2"></i>Old age</h6></li>
									    <li><h6><i class="icofont icofont-long-arrow-right mr-2"></i>Female gender</h6></li>
									    ...
									    <li><h6><i class="icofont icofont-long-arrow-right mr-2"></i>Weak muscles</h6></li>
									    <li><h6><i class="icofont icofont-long-arrow-right mr-2"></i>Poor hip stability</h6></li>
									    <li><h6><i class="icofont icofont-long-arrow-right mr-2"></i>Previous hip injury </h6></li>
								    </ul>
