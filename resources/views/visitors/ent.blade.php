@extends('visitors.layouts.visitorsApp',['title' => 'Ent'])
@section('content')
    ...
    <div class="auto-container mt-5">
        <div class="row">
            <div
                ...
                <h3>Specialized center for <span> ENT Treatment</span>
                </h3>
                <p>Most Advanced treatment of various diseases and disorders related to the Ear, Nose and Throat. Visit
       ...
       <div class="container">
           ...
           <div class="row">
		    <div class="col text-center mx-auto">
                   <img src="assets/img/Tight-anal-sphincter.jpg" class="piles-cause" alt="Tight anal sphincter">
                   <div class="card-body text-center mx-auto">
                       <p class="card-text cause-caption">Tight anal sphincter</p>
                   </div>
               </div>
               <div class="col text-center mx-auto">
                   <img src="assets/img/Passing large or hard stools frequently.jpg" class="piles-cause" alt="Passing large or hard stools frequently">
                   <div class="card-body">
               ...
               <div class="col text-center mx-auto">
                   <img src="assets/img/Decreased blood flow to the anal region.jpg" class="piles-cause" alt="Decreased blood flow to the anal region">
                   <div class="card-body">
...
<section class="section-padding bg-gray mt-7" >
 ...
 {{-- end section title --}}
           ...
           <div class="row">
		    <div class="col text-center mx-auto">
                   <img src="assets/img/Excessive Bleeding.jpg" class="piles-cause" alt="Anal Bleeding">
                   <div class="card-body text-center mx-auto">
                       <p class="card-text cause-caption">Anal Bleeding</p>
                   </div>
               </div>
               <div class="col text-center mx-auto">
                   <img src="assets/img/Minimal pain.jpg" class="piles-cause" alt="Rectal pain">
                   <div class="card-body">
                       <p class="card-text cause-caption">Rectal pain</p>
                   </div>
               </div>
               <div class="col text-center mx-auto">
                   <img src="assets/img/Cracked skin.jpg" class="piles-cause" alt="Cracked skin">
                   <div class="card-body">
                       <p class="card-text cause-caption">Cracked skin</p>
                   </div>
               </div>
               <div class="col text-center mx-auto">
                   <img src="assets/img/Itching.jpg" class="piles-cause" alt="Itchiness">
                   <div class="card-body">
                       <p class="card-text cause-caption">Itchiness</p>
                   </div>
               </div>
               <div class="col text-center mx-auto">
                   <img src="assets/img/Small lump or skin tag.jpg" class="piles-cause" alt="Small lump or skin tag">
                   <div class="card-body">
