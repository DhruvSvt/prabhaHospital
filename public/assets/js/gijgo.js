...
gj.dialog.config = {
    base: {
         ...
         *   <img src="wikipedia/en/thumb/8/80/Wikipedia-logo-v2_svg/1122px-Wikipedia-logo-v2.svg.png" width="420"/>
         * </div>
         * <script>
         *     $("#dialog").dialog({
         *         width: 'auto'
...
gj.tree.config = {
    base: {
         ...
         * <script>
         *     var tree = $('#tree').tree({
         *         dataSource: [ { text: 'World', imageUrl: 'content/icons/world-icon.png', children: [ { text: 'USA', imageUrl: 'content/icons/usa-oval-icon.png' } ] } ]
         *     });
         * </script>
         ...
         *     var tree = $('#tree').tree({
         *         imageUrlField: 'icon',
         *         dataSource: [ { text: 'World', icon: 'content/icons/world-icon.png', children: [ { text: 'USA', icon: 'content/icons/usa-oval-icon.png' } ] } ]
         *     });
         * </script>
         */
